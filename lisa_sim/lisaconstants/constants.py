...
the class attribute {attr}`lisaconstants.Constant.ALL`, a dictionary of all
available constants with names as keys.
...
constant object. Use the class method :meth:`Constant.alias` to create an alias.
The dictionary :attr:`Constant.ALL` will be updated such that the new alias
...
.. autoclass:: lisaconstants.Constant
    :members: __init__, alias
...
class Constant:
    ...
    """Dictionary of all defined constants."""

    @classmethod
    def alias(cls, name: str, original: str) -> None:
