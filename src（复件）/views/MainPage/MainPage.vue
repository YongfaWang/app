  ...
  <t-layout style="height: 100%;">
    <t-header>
      <t-head-menu value="item1" height="120px">
        ...
        <t-menu-item value="item1">窗口模式</t-menu-item>
    ...
    <t-dialog placement="center" v-model:visible="quitDialogVisible" theme="warning" header="Tip" body="Do you want to exit?" @confirm="quitApplication" />
    <t-dialog placement="center" v-model:visible="settingDialogVisible" header="Settings" @confirm="applySetting">
      <div>
        <p>深色模式</p>
