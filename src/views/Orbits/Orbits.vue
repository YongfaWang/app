<template>
  <div style="height: 100%">
    <IniConfig v-show="showIniConfig" :content="xmlContent" title="Orbits Configure" @onSaveAndRun="onSaveAndRun"
...
export default {
  ...
  data() {
    return {
      ...
      showIniConfig: true,
      logData: "",
      xmlPath: JSON.parse(localStorage.getItem("appSettings")).homeDir + "/testorbits/orbits.xml",
      pyPath: JSON.parse(localStorage.getItem("appSettings")).homeDir + "/testorbits/main_orbits.py",
    };
  },
  methods: {
    async copyLog() {
